...
- **Connect a real payment provider account** (Stripe/Paddle) — human step; service implements the webhook contract, no live payments until then. See dewey-cloud RUNBOOK.
