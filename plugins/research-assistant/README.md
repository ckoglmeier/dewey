...
|-------|-----------------|----------------|
| **research-competitive-analysis** | "who competes with us", "competitive landscape" | Momentum Framework, Positioning Matrix, Direct/Indirect/Adjacent categorization |
