...
> "competitive analysis of X" loads the research-competitive-analysis skill directly). When
...
| **Competitive Analysis** | Landscape scans, competitor profiles, positioning against rivals in the same domain | `../research-competitive-analysis/SKILL.md` |
